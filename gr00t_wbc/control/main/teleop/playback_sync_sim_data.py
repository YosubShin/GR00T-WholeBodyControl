"""
A convenience script to playback random demonstrations using the gr00t_wbc controller from
...
Example:
    $ python gr00t_wbc/control/main/teleop/playback_sync_sim_data.py --dataset output/robocasa_datasets/
...
from gr00t_wbc.control.main.teleop.configs.configs import SyncSimPlaybackConfig
from gr00t_wbc.control.robot_model.instantiation import get_robot_type_and_model
from gr00t_wbc.control.utils.sync_sim_utils import (
    generate_frame,
    get_data_exporter,
    get_env,
    get_policies,
...
from gr00t_wbc.data.exporter import TypedLeRobotDataset
...
if __name__ == "__main__":
    ...
    node = rclpy.create_node("playback_gr00t_wbc_control")
